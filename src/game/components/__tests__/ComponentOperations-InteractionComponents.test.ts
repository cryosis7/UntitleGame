...
describe('ComponentOperations - New Interaction Components', () => {
  ...
  describe('setComponent with new components', () => {
    it('should set RequiresItemComponent correctly', () => {
      ...
      expect(mockStore.set).toHaveBeenCalledWith('entitiesAtom', expect.any(Function));
      ...
      expect(updatedEntities[0].components[ComponentType.RequiresItem]).toEqual(component);
    });
    ...
    it('should set UsableItemComponent correctly', () => {
      ...
      expect(updatedEntities[0].components[ComponentType.UsableItem]).toEqual(component);
    });
    ...
    it('should set InteractionBehaviorComponent correctly', () => {
      ...
      expect(updatedEntities[0].components[ComponentType.InteractionBehavior]).toEqual(component);
    });
    ...
    it('should set SpawnContentsComponent correctly', () => {
      ...
      expect(updatedEntities[0].components[ComponentType.SpawnContents]).toEqual(component);
    });
  });
  ...
  describe('setComponents with multiple new components', () => {
    it('should set multiple new components at once', () => {
      ...
      expect(updatedEntities[0].components[ComponentType.RequiresItem]).toEqual(requiresItem);
      expect(updatedEntities[0].components[ComponentType.InteractionBehavior]).toEqual(interactionBehavior);
    });
  });
  ...
  describe('getComponentIfExists with new components', () => {
    beforeEach(() => {
      ...
      testEntity.components[ComponentType.RequiresItem] = new RequiresItemComponent({
        requiredCapabilities: ['unlock'],
        isActive: true,
      });
      ...
      testEntity.components[ComponentType.InteractionBehavior] = new InteractionBehaviorComponent({
        behaviorType: InteractionBehaviorType.SPAWN_CONTENTS,
        isRepeatable: true,
      });
      
      testEntity.components[ComponentType.SpawnContents] = new SpawnContentsComponent({
        contents: [],
        spawnOffset: { x: 0, y: 0 },
      });
    });
    ...
    it('should get RequiresItemComponent if it exists', () => {
      const component = getComponentIfExists(testEntity, ComponentType.RequiresItem);
    ...
    it('should get UsableItemComponent if it exists', () => {
      const component = getComponentIfExists(testEntity, ComponentType.UsableItem);
    ...
    it('should get InteractionBehaviorComponent if it exists', () => {
      const component = getComponentIfExists(testEntity, ComponentType.InteractionBehavior);
    ...
    it('should get SpawnContentsComponent if it exists', () => {
      const component = getComponentIfExists(testEntity, ComponentType.SpawnContents);
    ...
    it('should return undefined for non-existent new components', () => {
      ...
      expect(getComponentIfExists(entityWithoutComponents, ComponentType.RequiresItem)).toBeUndefined();
      expect(getComponentIfExists(entityWithoutComponents, ComponentType.UsableItem)).toBeUndefined();
      expect(getComponentIfExists(entityWithoutComponents, ComponentType.InteractionBehavior)).toBeUndefined();
      expect(getComponentIfExists(entityWithoutComponents, ComponentType.SpawnContents)).toBeUndefined();
    });
  });
  ...
  describe('getComponentAbsolute with new components', () => {
    ...
    it('should get component that exists', () => {
      const component = getComponentAbsolute(testEntity, ComponentType.RequiresItem);
  ...
  describe('hasComponent with new components', () => {
    ...
    it('should return true for existing new component', () => {
      expect(hasComponent(testEntity, ComponentType.InteractionBehavior)).toBe(true);
    });
  ...
  describe('hasAllComponents with new components', () => {
    ...
    it('should return true for single new component check', () => {
      expect(hasAllComponents(testEntity, ComponentType.RequiresItem)).toBe(true);
    });
  });
  ...
  describe('removeComponent with new components', () => {
    ...
    it('should remove single new component', () => {
      ...
      expect(updatedEntities[0].components[ComponentType.RequiresItem]).toBeUndefined();
      expect(updatedEntities[0].components[ComponentType.UsableItem]).toBeDefined();
      expect(updatedEntities[0].components[ComponentType.InteractionBehavior]).toBeDefined();
    });
    ...
    it('should remove multiple new components', () => {
      ...
      expect(updatedEntities[0].components[ComponentType.RequiresItem]).toBeUndefined();
      expect(updatedEntities[0].components[ComponentType.InteractionBehavior]).toBeUndefined();
      expect(updatedEntities[0].components[ComponentType.UsableItem]).toBeDefined();
    });
  });
