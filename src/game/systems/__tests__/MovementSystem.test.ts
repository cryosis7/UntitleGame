...
describe('MovementSystem', () => {
  ...
  describe('Entity Position Updates', () => {
    it('manual setComponent test for position', () => {
      ...
      console.log(
        'Initial position:',
        getComponentIfExists(entity, ComponentType.Position),
      );
    ...
    it('should not move entity if velocity is zero', () => {
      ...
      const originalPosition = getComponentIfExists(
        entity,
        ComponentType.Position,
      );
  ...
  describe('Collision Detection and Validation', () => {
    ...
    it('should push movable entities when possible', () => {
      ...
      updateArgs = createTestUpdateArgs(
        [pushingEntity, movableEntity],
        createMockGameMap(),
      );
      system.update(updateArgs);

      // Both entities should move
      const pushingPosition = getComponentIfExists(
        pushingEntity,
        ComponentType.Position,
      );
  ...
  describe('System Edge Cases and Validation', () => {
    ...
    it('should handle multiple entities with complex interactions', () => {
      ...
      const firstPosition = getComponentIfExists(
        entities[0],
        ComponentType.Position,
      );
      ...
      const fourthPosition = getComponentIfExists(
        entities[3],
        ComponentType.Position,
      );
