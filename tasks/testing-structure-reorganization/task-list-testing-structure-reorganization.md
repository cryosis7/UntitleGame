...
- [ ] **T009: Migrate GameRenderSystem Tests**
    - [ ] Locate existing GameRenderSystem test files
    - [ ] Create `src/game/systems/GameRenderSystem.test.ts` adjacent to source file
...
- [ ] **T017: Create Player Movement Integration Test**
    ...
    - [ ] Test systems interaction: KeyboardInputSystem, MovementSystem, GameRenderSystem
